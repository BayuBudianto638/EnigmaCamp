...
namespace DataTypes.Services.Students
{
    public class StudentService : IStudentService
    {
        ...
        {
            //using (var context = new SchoolContext(_dbContextOptions))
            //{
        ...
        {
            //var context = new SchoolContext();
            var student = _context.Students.FirstOrDefault(w => w.StudentId == studentId);
        ...
        {
            //var context = new SchoolContext();
            var student = _context.Students.FirstOrDefault(w => w.Name.Contains(name));
            return student;
        }
